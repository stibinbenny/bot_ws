...
#include "bot_msgs/srv/add_two_ints.hpp"
...
public:
    ...
    {
        client_ = create_client<bot_msgs::srv::AddTwoInts>("add_two_ints");

        auto request = std::make_shared<bot_msgs::srv::AddTwoInts::Request>();
        request->a = a;
        request->b = b;
...
private:
    rclcpp::Client<bot_msgs::srv::AddTwoInts>::SharedPtr client_;

    void responseCallback(rclcpp::Client<bot_msgs::srv::AddTwoInts>::SharedFuture future)
    {
        if(future.valid())
        {
...
//ros2 run  bot_cpp_examples simple_service_server
//ros2 run  bot_cpp_examples simple_service_client 5 3
//ros2 service list