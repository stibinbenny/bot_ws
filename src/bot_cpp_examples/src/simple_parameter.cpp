    ...
    for (const auto &param : parameters) {
      if (param.get_name() == "simple_int_param" &&
        ...
        RCLCPP_INFO_STREAM(get_logger(),
                           "Param simple_int_param changed! New value is "
                               << param.as_int());
      ...
      if (param.get_name() == "simple_string_param" &&
        ...
        RCLCPP_INFO_STREAM(get_logger(),
                           "Param simple_string_param changed! New value is "
                               << param.as_string());
        result.successful = true;
      }
    }
...
//ros2 run bot_cpp_examples simple_parameter
//ros2 param list
//ros2 param get /simple_parameter simple_int_param
//ros2 param set /simple_parameter simple_string_param "stibin"