...
from bot_msgs.action import Fibonacci
import time
...
# ros2 run bot_py_examples Action_server
# ros2 run bot_py_examples Action_client

# ros2 action list
# ros2 action info /fibonacci -t
# ros2 action send_goal /fibonacci bot_msgs/action/Fibonacci "order: 10" -f
