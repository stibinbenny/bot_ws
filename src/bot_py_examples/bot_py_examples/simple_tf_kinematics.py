...
class SimpleTfKinematics(Node):
    ...
    def __init__(self):
        ...
        self.static_transform_stamped_.transform.rotation.y = 0.5
        ...
        self.orientation_increment_ = quaternion_from_euler(1.57, 0, 0)# in radians
...
#ros2 run bot_py_examples simple_tf_kinematics
#rviz2 rviz2
#ros2 topic list and echo /tf_static 

#ros2 run bumperbot_py_examples simple_tf_kinematics
#rviz2 rviz2
#ros2 service list
#ros2 service call /get_transform bumperbot_msgs/srv/GetTransfrom "frame_id: 'bumperbot_base'  child_frame_id: 'bumperbot_top'"
